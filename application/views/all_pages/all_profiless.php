...
<section id="main">
    <aside id="sidebar" class="sidebar c-overflow">
        ...
        <ul class="main-menu">
            <li><a href="<?php echo base_url();?>"><i class="zmdi zmdi-home"></i> Home</a></li>
            <li><a href="<?php base_url('all-profiles');?>"><i class="zmdi zmdi-home"></i> All Profiles</a></li>
        </ul>
    </aside>
        ...
        <div class="container">
            ...
            <div class="col-sm-4">
                ...
                <div class="card profile-view">
                    <div class="pv-header">
                        <img class="img-responsive" src="<?php echo base_url('assets/img/headers/sm/4.png')?>" >
                        <img src="<?php echo base_url('assets/img/profile-pics/profile-pic.jpg');?>" class="pv-main" alt="">
                    </div>
                    ...
                    <div class="pv-body">
                        ...
                        <ul class="pv-contact">
                            <di><dd><i class="zmdi zmdi-home"></i>
                                    Udaipurudaipur</dd></di>
                            <di><dd><i class="zmdi zmdi-calendar"></i>
                                    26-10-1990</dd></di>
                            <di><dd><i class="zmdi zmdi-book"></i>
                                    BBM,MBA</dd></di>
                        </ul>
                        <ul class="pv-follow">
                            <li>589</li>
                            <li>Peoples Interested</li>
                        </ul>

                        <a href="" class="pv-follow-btn">Show more info...</a>
                    </div>
                </div>
                ...
                <div class="card profile-view">
                    <div class="pv-header">
                        <img class="img-responsive" src="<?php echo base_url('assets/img/headers/sm/2.png')?>" >
                        <img src="<?php echo base_url('assets/img/profile-pics/profile-pic.jpg');?>" class="pv-main" alt="">
                    </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="card profile-view">
                    <div class="pv-header">
                        <img class="img-responsive" src="<?php echo base_url('assets/img/headers/sm/6.png')?>" >
                        <img src="<?php echo base_url('assets/img/profile-pics/profile-pic.jpg');?>" class="pv-main" alt="">
                    </div>
            ...
            <div class="col-sm-4">
                ...
                <div class="card profile-view">
                    ...
                    <div class="pv-body">
                        ...
                        <!--                                <dt><i class="zmdi zmdi-home"></i></dt>-->
                        <!--                                <dd>Udaipur</dd>-->
                        <!--                            </dl>-->
                        <!--                            <dl class="dl-horizontal">-->
                        <!--                                <dd><i class="zmdi zmdi-calendar"></i>-->
                        <!--                                26-10-1990</dd>-->
                        <!--                            </dl>-->
                        <!--                            <dl class="dl-horizontal">-->
                        <!--                                <dd><i class="zmdi zmdi-book"></i>-->
                        <!--                                BBM, MBA</dd>-->
                        <!--                            </dl>-->
                        <!--                        </div>-->
                        <ul class="pv-follow">
